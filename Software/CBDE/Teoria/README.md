...
- DTIM & UPC:
    - [02-NOSQL](01-NOSQL_Databases/02-NOSQL)
    - [03-DistributedDBs](01-NOSQL_Databases/03-DistributedDBs)
...
- MIT CSAIL *(Michael Stonebraker, Samuel Madden, Daniel J. Abadi, Stavros Harizopoulos)* & AvantGarde Consulting, LLC *(Nabil Hachem)* & Microsoft Corporation *(Pat Helland)*:
    - [Introduction-Stonebraker-endofera](01-NOSQL_Databases/Introduction-Stonebraker-endofera)
    - [Additional-Material-1st_BOTTLENECK_-_Logging](01-NOSQL_Databases/Additional-Material-1st_BOTTLENECK_-_Logging)
