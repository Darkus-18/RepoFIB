...
import junit.com.PayStationImpl.ReceiptType;
import org.junit.*;
...
public class TestPayStation {
  PayStation ps = new PayStationImpl(new LinearRateStrategy(), ReceiptType.STANDARD);
  PayStation ps1 = new PayStationImpl(new ProgressiveRateStrategy(), ReceiptType.BARCODE);
  ...
  */
  @Test 
  public void shouldReturnCorrectReceiptWhenBuyNY() 
	...
	receiptContent = receiptContent + "\n";
	receiptContent = receiptContent + "         Value " + 16 + " minutes";
	receiptContent = receiptContent + "\n";
	receiptContent = receiptContent + "STANDARD RECEIPT";
	receiptContent = receiptContent + "----------------------------------";
	assertEquals(receiptContent, receipt.print());
  }
  ...
  */
  ...
  @Test 
  public void shouldReturnCorrectReceiptWhenBuyBT() 
    throws IllegalCoinException {
    ps1.addPayment(5);
    ps1.addPayment(10);
    ps1.addPayment(25);
